...
const AWSCostChecklist = () => {
  ...
  // Light/Dark mode toggle - initialized with null and set in useEffect
        ...
        <div className={`rounded-xl shadow-lg mb-8 overflow-hidden transition-colors duration-300 ${darkMode ? 'bg-gray-800 border border-gray-700' : 'bg-white'}`}>
          <div className="p-6">
            <div className="flex flex-col md:flex-row justify-between items-center mb-6">
              ...
              <div className="flex flex-col justify-center space-y-2 md:space-y-0 md:flex-row md:space-x-3 flex-wrap">
                <button 
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="hidden md:flex items-center gap-3 ml-4">
                    ...
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                      getScoreRating(calculateSectionProgress(section)).color
                    } ${
                      getScoreRating(calculateSectionProgress(section)).bgColor
                    } ${
                      darkMode ? getScoreRating(calculateSectionProgress(section)).darkBgColor : ''
                    }`}>
